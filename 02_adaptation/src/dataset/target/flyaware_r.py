...
class FLYAWARER(TargetDataset):
    task = 'segmentation'
    ds_type = 'supervised'
    category = "drone"

    dataset_dir = 'FLYAWARE-R'

    #labels2train = {0: 4, 1: 0, 2: 3, 3: 1, 4: 1, 5: 3, 6: 2, 7: 255}
    ...
    images_dir = os.path.join('FLYAWARE-R')
    target_dir = os.path.join('FLYAWARE-R')
