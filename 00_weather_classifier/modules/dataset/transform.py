...
class FixedResize(object):
    def __init__(self, width=None, height=None,  interpolation=InterpolationMode.BILINEAR):
        self.width = width
        self.height = height
    ...
    def __call__(self, img, lbl=None):
        ...
        if lbl is not None:
            return F.resize(img, size, self.interpolation), F.resize(lbl, size, InterpolationMode.NEAREST)
        else:
