...
__all__ = ['SingleBatchSampler', 'MixedBatchSampler']
...
class MixedBatchSampler(BatchSampler):
    ...
    that has both category of data cars and drones (only SynSELMA).
    ...
    def __init__(self, classes: dict, batch_size: int, drop_last: bool, shuffle: bool, generator: torch.Generator = None, fuse_strategy = 'rnd') -> None:
