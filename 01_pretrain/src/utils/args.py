...
SOURCE_DATASETS = ['gta5', 'selma', 'selma_flyawares', 'gta_flyawares', 'acdc_flyawarer', 'flyawares']
TARGET_DATASETS = ['cityscapes', 'crosscity', 'mapillary', 'flyawarer', 'flyawarerxl', 'acdc']
...
CL_TYPE = {
    ...
    "flyawarer": ["heterogeneous", "heterogeneous_only_clear"],
    "acdc": ["heterogeneous", "heterogeneous_only_clear"],
    "flyawarerxl": ["heterogeneous", "heterogeneous_only_clear"],
}
...
def check_args(args):
    ...
    if "crosscity" not in args.target_dataset:
...
def parse_args():
    ...
    # ||| Dataset Options |||
    parser.add_argument('--root', type=str, required=False, default='root', help='dataset root path')
    ...
    parser.add_argument('--target_dataset', type=str, nargs="+", choices=TARGET_DATASETS, required=True,
    ...
    parser.add_argument('--only_clear', action='store_true', default=False, help='Use only clear images during training')
    ...
    parser.add_argument('--qualitative', type=str, default=None, choices=[None, "file", "wandb"])
    parser.add_argument('--qualitative_dir', type=str, default=None, help="dir where qualitative results will be saved")
    parser.add_argument('--pretrained_ckpt_cr', type=str, default=None, help="path to the downloaded ckpt")
