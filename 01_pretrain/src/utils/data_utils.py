...
class DatasetHandler(object):
    ...
    def __gen_ds(self, paths, dataset_name, dataset, train_transform, test_transform, split='train', hp_filtered=False):
        ...
        if dataset_name in ['crosscity', 'mapillary', 'acdc', 'flyawarer', 'flyawarerxl']:
            return dataset(paths, root=self.args.root, transform=train_transform, test_transform=test_transform,
...
def color_map(dataset):
    ...
    if dataset == ['cityscapes'] or dataset == ['mapillary'] or dataset == ['acdc'] or sorted(dataset) == ['acdc', 'flyawarer'] or sorted(dataset) == ['acdc', 'flyawarerxl']:
        ...
        color = [(128, 64, 128), (244, 35, 232), (70, 70, 70), (250, 170, 30), (220, 220, 0), (107, 142, 35),
                 ...
                 (0, 0, 0)]
        n = 256
    elif dataset == ['flyawarer'] or dataset == ['flyawarerxl']:
