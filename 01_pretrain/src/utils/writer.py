...
class Writer:
    ...
    def __init__(self, local_rank):
        ...
        self.valid_target_ds_names = (['cityscapes'], ['crosscity'], ['mapillary'], ['acdc'], ['flyawarer'], ['acdc', 'flyawarer'],
                                      ['flyawarer', 'acdc'], ['flyawarerxl'], ['acdc', 'flyawarerxl'], ['flyawarerxl', 'acdc'])
    ...
    def get_fda_pretrained_model(self):
        ...
        def restore(run_id, best: bool):
            try:
                ...
                ckpt_path = '/'.join(
                    ['checkpoints', self.args.framework, self.args.source_dataset, target_dts_name,
                     f'pretrained_server{f"{run_id}_best" if best else ""}.ckpt'])
