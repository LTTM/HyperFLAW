...
from .target import Cityscapes, CrossCity, Mapillary, ACDC, FLYAWARER, FLYAWARERXL
from .source import GTA5, SELMA, FLYSELMA, ACFLY, FLYAWARES, FLYGTA
...
def get_dataset(model_name, dataset_name, double_dataset=None, quadruple_dataset=None, target_dataset=None, cv2=False,
    ...
    if dataset_name == 'cityscapes':
    ...
    elif dataset_name == 'selma_flyawares':
        mean = (0.485, 0.456, 0.406)
        std = (0.229, 0.224, 0.225)
        dataset = partial(FLYSELMA, mean=mean, std=std, cv2=cv2, target_dataset=target_dataset)
        train_transform = [
            tr.RandomScale((0.7, 2)),
            tr.RandomCrop((512, 1024), pad_if_needed=True),
            tr.ToTensor(),
    ...
    elif dataset_name == 'gta_flyawares':
        mean = (0.485, 0.456, 0.406)
        std = (0.229, 0.224, 0.225)
        dataset = partial(FLYGTA, mean=mean, std=std, cv2=cv2, target_dataset=target_dataset)
        train_transform = [
            tr.RandomScale((0.7, 2)),
            tr.RandomCrop((512, 1024), pad_if_needed=True),
            tr.ToTensor(),
    ...
    elif dataset_name == 'flyawares':
        mean = (0.485, 0.456, 0.406)
        std = (0.229, 0.224, 0.225)
        dataset = partial(FLYAWARES, mean=mean, std=std, cv2=cv2, target_dataset=target_dataset)
        train_transform = [
            tr.RandomScale((0.7, 2)),
            tr.RandomCrop((512, 1024), pad_if_needed=True),
            tr.ToTensor(),
    ...
    elif dataset_name == 'acdc_flyawarer':
        mean = (0.485, 0.456, 0.406)
        std = (0.229, 0.224, 0.225)
        dataset = partial(ACFLY, mean=mean, std=std, cv2=cv2, target_dataset=target_dataset)
        train_transform = [
            tr.RandomScale((0.7, 2)),
            tr.RandomCrop((512, 1024), pad_if_needed=True),
            tr.ToTensor(),
    ...
    elif dataset_name == 'selma':
        mean = (0.485, 0.456, 0.406)
        std = (0.229, 0.224, 0.225)
        dataset = partial(SELMA, mean=mean, std=std, cv2=cv2, target_dataset=target_dataset)
        train_transform = [
            tr.RandomScale((0.7, 2)),
            tr.RandomCrop((512, 1024), pad_if_needed=True),
            tr.ToTensor(),
        ...
        mean = (0.485, 0.456, 0.406)
        std = (0.229, 0.224, 0.225)
        dataset = partial(ACDC, mean=mean, std=std, cv2=cv2)
    ...
    elif dataset_name == 'flyawarer':
        mean = (0.485, 0.456, 0.406)
        std = (0.229, 0.224, 0.225)
        dataset = partial(FLYAWARER, mean=mean, std=std, cv2=cv2)
    ...
    elif dataset_name == 'flyawarerxl':
        mean = (0.485, 0.456, 0.406)
        std = (0.229, 0.224, 0.225)
        dataset = partial(FLYAWARERXL, mean=mean, std=std, cv2=cv2)
